...
@admin.register(MiniSliders)
class MiniSlidersAdmin(admin.ModelAdmin):
    list_display = ('id', 'upper_text', 'marked_text', 'main_text')
    list_display_links = ('id', 'upper_text', 'marked_text', 'main_text')
